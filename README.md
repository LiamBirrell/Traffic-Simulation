...
# **Optimisation:**
The core optimisation engine utilises a Logic-Based Benders Decomposition (LBBD) architecture to integrate a Gurobi mathematical solver directly with the stochastic traffic simulation. Full mathematical formulation can be found ![here](documentation/Phase-Model_Formulation.pdf) (located in the documentation file)
...
### Conclusion:
This project shows that optimisation beats fixed timing for complex traffic patterns. By coupling simulation with Logic-Based Benders' decomposition, the system found a schedule that increased throughput by 12% (342 additional cars).
