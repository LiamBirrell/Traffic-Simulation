...
exit_lane_weights = {
    ...
    ("INT1","NB_LANE_2"):{"INT4_EB_LANE_2_EXT": 1,
                          # "INT4_WB_LANE_1_EXT": 0.5,
                                },
...
connections = {
    ...
    # Southbound
    ("INT1", "SB_LANE_1"):[("INT1_SB_LANE_1_EXT"), ("INT1_EB_LANE_1_EXT")],
